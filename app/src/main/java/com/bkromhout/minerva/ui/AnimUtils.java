...
public class AnimUtils {
     ...
     * <p>
     * Interrupting Activity transitions can yield an OperationNotSupportedException when the transition tries to pause
     * the animator. Yikes! We can fix this by wrapping the Animator:
     */
    ...
    /**
     * Shim which wraps {@link android.transition.Transition.TransitionListener} so that we can just implement the
